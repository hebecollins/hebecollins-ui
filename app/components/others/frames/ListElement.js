...
export const ListElement =
    ({index, nick_name, img_thumb, first_name, middle_name, last_name, workout_update_date, joining_date, onClick}) => {
        return (
            <a onClick={()=>onClick(index)} className="list-individual-data">
