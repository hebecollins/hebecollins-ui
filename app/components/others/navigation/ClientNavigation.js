...
export const ClientNavigation =({logout})=>{
     const clientLinks = (
            <ul className="nav navbar-nav navbar-right">
                ...
                <li>
                    <NavLink to={getRouteByName("CLIENT_PROFILE_IN_EDIT_MODE")} onlyActiveOnIndex>Profile</NavLink>
                </li>
                <li>
                ...
                <li>
                    <NavLink to={getRouteByName("GYM_PROFILE_IN_VIEW_MODE")} onlyActiveOnIndex>Gym</NavLink>
                </li>
